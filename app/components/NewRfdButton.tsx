  ...
  return (
    <div>
      {adjustedFrom !== undefined && (
        <p className="text-notice bg-notice-secondary text-sans-sm mb-4 rounded p-2">
          Note: RFD {adjustedFrom.toString().padStart(4, '0')} already has a branch.
          Adjusted to the next available number.
        </p>
      )}
      <p className="mb-4">
        ...
        <input
          ...
          min={1}
          className="bg-raise border-secondary text-sans-sm w-20 rounded border px-1.5 py-0.5 text-center font-mono"
        />
        ?
      </p>
      <p className="text-tertiary text-sans-sm mb-6">
        This will create branch{' '}
        <code className="bg-raise border-secondary rounded border px-1 py-0.5">
          rfd-{formattedNumber}
        </code>{' '}
        and open the branch on GitHub.
      </p>
      ...
      <div className="flex justify-end gap-2">
        ...
        <button onClick={onConfirm} className={buttonStyle({ size: 'sm' })}>
  ...
  return (
    <div>
      ...
      <p className="mb-4">
        ...
        , you need to {isReconnect ? 'reconnect' : 'connect'} your GitHub account with
        repository access.
      </p>
      <p className="text-tertiary text-sans-sm mb-6">
        This grants temporary access to create branches in the RFD repository. Your GitHub
      ...
      <Form method="post" action="/auth/github-repo">
        ...
        <div className="flex justify-end">
          <button type="submit" className={buttonStyle({ size: 'sm' })}>
  ...
  return (
    <div>
      ...
      <div className="flex justify-end gap-2">
        ...
        {canRetry && (
          <button onClick={onRetry} className={buttonStyle({ size: 'sm' })}>
            Retry
          </button>
        )}
      </div>
  ...
  return (
    <div>
      <div className="mb-4 flex items-start gap-2">
        ...
        <div>
          <p className="text-error mb-2 font-medium">Repository Access Required</p>
          <p className="text-secondary text-sans-sm">{message}</p>
        </div>
      </div>
      <p className="text-tertiary text-sans-sm mb-6">
        To create RFDs, you need write access to the repository. This is typically granted
        by adding you as a collaborator or team member with push permissions.
      </p>
      <div className="flex justify-end">
        <button onClick={onClose} className={buttonStyle({ size: 'sm' })}>
          Close
