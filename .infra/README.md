...
The application supports two storage backends for serving static assets: GCS (Google Cloud Storage)
and S3 (AWS S3 or S3-compatible services).
...
via environment variables, IAM instance roles, ECS task roles, or other standard AWS methods.
